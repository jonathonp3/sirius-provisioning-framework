...
install -Dpm0755 %{SOURCE1}  %{buildroot}%{_libexecdir}/sirius/template-extract.sh
install -Dpm0644 %{SOURCE2}  %{buildroot}%{_datadir}/sirius/template/template-extract.service
install -Dpm0644 %{SOURCE3}  %{buildroot}%{_datadir}/sirius/template/template-extract.timer
install -Dpm0755 %{SOURCE4}  %{buildroot}%{_libexecdir}/sirius/template-deploy.sh
install -Dpm0644 %{SOURCE5}  %{buildroot}%{_datadir}/sirius/template/template-deploy.service
install -Dpm0644 %{SOURCE6}  %{buildroot}%{_datadir}/sirius/template/template-deploy.path
install -Dpm0755 %{SOURCE7}  %{buildroot}%{_libexecdir}/sirius/template-provision.sh
install -Dpm0644 %{SOURCE8}  %{buildroot}%{_unitdir}/template-provision.service
install -Dpm0755 %{SOURCE9}  %{buildroot}%{_libexecdir}/sirius/template-uninstall-provision.sh
...
%{_libexecdir}/sirius/template-extract.sh
%{_libexecdir}/sirius/template-deploy.sh
%{_libexecdir}/sirius/template-provision.sh
%{_libexecdir}/sirius/template-uninstall-provision.sh

%dir %{_datadir}/sirius/template
%{_datadir}/sirius/template/template-extract.service
%{_datadir}/sirius/template/template-extract.timer
%{_datadir}/sirius/template/template-deploy.service
%{_datadir}/sirius/template/template-deploy.path
...
%changelog
* Mon Sep 14 2026 Jonathon P <jonathon@wolf-os> - 1.0.0-1
